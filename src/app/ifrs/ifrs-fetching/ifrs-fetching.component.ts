...
import { FctCreditBalance } from 'src/app/mda/FctCreditBalance';
declare const $;
...
@Component({
  selector: 'app-ifrs-fetching',
  templateUrl: './ifrs-fetching.component.html',
  styleUrls: ['./ifrs-fetching.component.css']
})
export class IfrsFetchingComponent implements OnInit {
