...
export class SecurityPolicyComponent implements OnInit {
  editbut: boolean= true;
  savbut: boolean = false;
  auth:boolean = true;
  ...
  constructor(private route: ActivatedRoute, private router: Router,
    private securityServ: APIService, private cdr: ChangeDetectorRef) { }
  ...
  onsaveEditOfSecurityPolicy() {
    ...
    this.securityServ.onSaveOfSecurityPolicy(this.security).subscribe(editSecurityPolicyResp => {
      ...
      if(this.security.min_pswd_length > this.security.max_pswd_length) {
        ...
        this.security = editSecurityPolicyResp;
        this.commonAuditlog();
        this.cdr.markForCheck();
        this.editbut= true;
        this.savbut = false;
        this.auth = true;
        // this.editOfSecurityPolicy();
        Swal.fire({
  ...
  ViewUnAuthReocrds()
  {
    ...
    this.router.navigateByUrl('/securitySummary')
  }
}